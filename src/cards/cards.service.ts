...
export class CardsService {
  ...
  async create(req: Request, res: Response, createCardDto: CreateCardDto) {
    ...
    if (!isUserOwnsCardSet) {
      throw new BadRequestException('You can\'t update a card set that you does not own')
    }
  ...
  async update(req: Request, res: Response, id: string, updateCardDto: UpdateCardDto) {
    const { id: ownerId } = req.user as User
    ...
    if (!isUserOwnsCardSet) {
      throw new BadRequestException('You can\'t update a card in the card set that you does not own')
    }
  ...
  async remove(req: Request, res: Response, id: string) {
    ...
    if (!cardSet) {
      throw new BadRequestException('You can\'t remove card set that you does not own')
    }
  ...
  async uploadAvatar(req: Request, res: Response, id: string, body: UploadAvatarDto) {
