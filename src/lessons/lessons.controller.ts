...
export class LessonsController {
  ...
  @Post()
  create(req: Request, res: Response, @Body() createLessonDto: CreateLessonDto) {
  ...
  @Patch(':id')
  update(req: Request, res: Response, @Param('id') id: string, @Body() updateLessonDto: UpdateLessonDto) {
