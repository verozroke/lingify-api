...
export class CoursesController {
  ...
  @Post()
  create(@Req() req: Request, @Res() res: Response, @Body() createCourseDto: CreateCourseDto) {
  ...
  @Get('/name/:courseName')
  findOneByName(@Req() req: Request, @Res() res: Response, @Param('courseName') courseName: string) {
    return this.coursesService.findOneByName(req, res, courseName);
  }

  @Patch(':id')
  update(@Req() req: Request, @Res() res: Response, @Param('id') id: string, @Body() updateCourseDto: UpdateCourseDto) {
