...
export class CardSetsService {
  ...
  async create(req: Request, res: Response, createCardSetDto: CreateCardSetDto) {
  ...
  async update(req: Request, res: Response, id: string, updateCardSetDto: UpdateCardSetDto) {
    ...
    if (!isUserOwnsCardSet) {
      throw new BadRequestException('You can\'t update card set that you does not own')
    }
