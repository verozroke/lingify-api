...
export class CardSetsController {
  ...
  @Post()
  create(req: Request, res: Response, @Body() createCardSetDto: CreateCardSetDto) {
  ...
  @Get('all/:ownerId')
  findAllByOwnerId(req: Request, res: Response, @Param('ownerId') ownerId: string) {
    return this.cardSetsService.findAllByOwnerId(req, res, ownerId)
  }

  @UseGuards(JwtAuthGuard)
  @Patch(':id')
  update(req: Request, res: Response, @Param('id') id: string, @Body() updateCardSetDto: UpdateCardSetDto) {
