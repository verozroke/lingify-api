...
export class CommunitiesService {
  ...
  async create(req: Request, res: Response, dto: CreateCommunityDto) {
    const { name, language, ownerId, description, countryName, bannerUrl, avatarUrl } = dto
  ...
  async subscribe(req: Request, res: Response, { communityId, userId }: SubCommunityDto) {
    ...
    if (!community) {
      throw new BadRequestException('Community not found for id ' + communityId);
    }
  ...
  async unsubscribe(req: Request, res: Response, { communityId, userId }: SubCommunityDto) {
