...
export class CommunitiesController {
  ...
  @Post()
  create(@Req() req: Request, @Res() res: Response, @Body() createCommunityDto: CreateCommunityDto) {
  ...
  @Patch(':id')
  update(@Req() req: Request, @Res() res: Response, @Param('id') id: string, @Body() updateCommunityDto: UpdateCommunityDto) {
  ...
  @Post('/sub')
  subscribe(@Req() req: Request, @Res() res: Response, @Body() subCommunityDto: SubCommunityDto) {
    return this.communitiesService.subscribe(req, res, subCommunityDto);

  }

  @Post('/unsub')
  unsubscribe(@Req() req: Request, @Res() res: Response, @Body() subCommunityDto: SubCommunityDto) {
    return this.communitiesService.unsubscribe(req, res, subCommunityDto);

  }

  @Get('/search/:q')
  search(@Param() params: { q: string }, @Req() req: Request, @Res() res: Response) {
