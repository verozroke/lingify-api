...
export class CommentsService {
  ...
  async create(req: Request, res: Response, createCommentDto: CreateCommentDto) {
  ...
  async update(req: Request, res: Response, id: string, updateCommentDto: UpdateCommentDto) {
